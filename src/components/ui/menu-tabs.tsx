...
const tabs: Tab[] = [
  { name: "Overview", href: "/menu/overview", icon: LayoutGrid },
  { name: "Menus", href: "/menu/menus", icon: Clock },
  { name: "Categories", href: "/menu/categories", icon: FolderOpen },
  { name: "Items", href: "/menu/items", icon: Package },
  { name: "Customizations", href: "/menu/customizations", icon: Settings2 },
]
